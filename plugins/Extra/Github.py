...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('✨ Updates Channel ✨', url='https://t.me/TeleRoidGroup')]])
...
async def getgithub(bot, message):
    ...
    k = await message.reply_text("**Checking the github...⏳**", quote=True)    
...
**🌟 © @KDramasFlix | @SingleMachiNetworks 🌟 **"""
